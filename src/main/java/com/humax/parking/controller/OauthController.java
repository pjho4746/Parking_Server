...
//    private String myPageUrl;
    ...
    public void redirectToKakaoLogin(HttpServletResponse response) throws IOException {
        response.sendRedirect("https://kauth.kakao.com/oauth/authorize?client_id=9f5309f7fc6b371a2a96d9cfdbd304cd&redirect_uri=https://turu-parking.com/oauth/kakao/login&response_type=code");
    }
